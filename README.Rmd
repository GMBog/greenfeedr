...
The greenfeedr ShinyApp is hosted on shinyapps.io here: [https://gmbog.shinyapps.io/shinyapp/](https://gmbog.shinyapps.io/shinyapp/)

When using RStudio you can also run the **greenfeedr** app directly on your computer with:
