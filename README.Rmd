...
Or if using RStudio you can also run the ShinyApp directly on your computer with:

```{r run app locally, eval=FALSE}
...
Learn how to use greenfeedr in different workflows:
  ...
  - [2. Reporting Data](https://github.com/GMBog/greenfeedr/blob/main/inst/md/ReportData.md)
