...
Note that we can use the preliminary data downloaded by API using `get_gfdata()` or the finalized data downloaded from the [webinterface](https://ext.c-lockinc.com/greenfeed/data.php).  
