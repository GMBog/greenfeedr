...
* `dailyrep()` downloads and generates PDF reports of daily GreenFeed data.
...
These all use the same daily and final data from GreenFeed system to provide a wide range of opportunities to data processing.
