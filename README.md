...
> Martinez-Boggio et al. (2025). greenfeedr: An R package for processing
> and reporting GreenFeed data. *JDS Communications*.
...
[CRAN](https://CRAN.R-project.org/package=greenfeedr):
...
Prefer a point-and-click interface? Run the interactive ShinyApp
...
example on [GitHub](https://github.com/GMBog/greenfeedr/issues).

For questions or feedback, contact [Guillermo
